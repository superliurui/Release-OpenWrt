...
#修改网络唤醒为管控模式下
sed -i 's/services/control/g' package/lean/luci-app-wol/luasrc/controller/wol.lua 
#修改磁盘休眠为管控模式下
sed -i 's/services/control/g' package/lean/luci-app-hd-idle/luasrc/controller/hd_idle.lua 
